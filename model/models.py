...
class TagManager:
    """Huolehtii tunnisteiden lukemisesta ja kirjoittamisesta 
    tunnistetiedostoon."""
...
class EventExtractor:
    ...
    def events_from_file(self, path):
        ...
        try:
            ...
            file = os.path.join(path, events_filename)
...
class Dao:
    ...
    def write_settings(self, transactions_dir, save_dir):
        ...
        connection = pymysql.connect(self.address, self.username, self.password,
                                     self.database)
